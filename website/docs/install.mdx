---
title: "Install ObjectBox Swift"
description: "ObjectBox is a NoSQL Swift database uniquely optimized for high-performance on smartphones. Learn how to set up ObjectBox Swift and persist objects in your i..."
keywords:
  - objectbox
  - swift
  - ios
...
<TechnicalArticleSchema
  headline="Install ObjectBox Swift"
  description="ObjectBox is a NoSQL Swift database uniquely optimized for high-performance on smartphones. Learn how to set up ObjectBox Swift and persist objects in your i..."
  url="https://swift.objectbox.io/install"
...
* [CocoaPods](install#cocoapods) pod
* [Swift Package](install#swift-package)

Alternatively, a [manual setup in Xcode](advanced/manual-installation) is possible.
...
![](/img/assets/Screenshot 2024-09-23 at 14.40.58.png)
...
Now, you are all set to define your first ObjectBox entities! To continue check the [Getting Started guide](getting-started) or [the example project](https://github.com/objectbox/objectbox-swift/tree/main/Example).
...
![](/img/assets/Xcode-buildsettings-bitcode.png)
