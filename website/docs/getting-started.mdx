---
title: "Getting Started with ObjectBox Swift"
description: "Learn how to use ObjectBox NoSQL DB to persist data with swift for an Offline-first iOS app experience. ObjectBox performs well on all CRUD operations and is..."
keywords:
  - objectbox
  - swift
  - ios
...
<TechnicalArticleSchema
  headline="Getting Started with ObjectBox Swift"
  description="Learn how to use ObjectBox NoSQL DB to persist data with swift for an Offline-first iOS app experience. ObjectBox performs well on all CRUD operations and is..."
  url="https://swift.objectbox.io/getting-started"
...
See [**Install ObjectBox**](install) if you haven't already. This guide assumes ObjectBox was added using CocoaPods.
...
Next, [review and keep the generated files](getting-started#review-and-keep-generated-files).
...
:::tip
The model file also enables you to keep data [when renaming entities or properties](advanced/data-model-updates#renaming-entities-and-properties) or to [resolve conflicts](https://docs.objectbox.io/advanced/meta-model-ids-and-uids) when two of your developers make changes at the same time.
:::
...
:::warning
Getting "**Missing argument for parameter 'model'**..." here? Make sure to [generate ObjectBox code](getting-started#generate-objectbox-code) first.\
\
...
* **query:** Lets you provide a query expression to retrieve objects by certain criteria. See [the page on queries](queries) for details.
...
For details, check the [Transaction guide](transactions) and [the API docs for Store](https://objectbox.io/docfiles/swift/current/Classes/Store.html) for details.