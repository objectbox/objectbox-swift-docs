...
description: "If you aren't using CocoaPods, ObjectBox can easily be installed manually. Just download, add the framework to your project, and run our setup script."
keywords:
  - objectbox
  - swift
  - ios
...
<TechnicalArticleSchema
  ...
  description="If you aren't using CocoaPods, ObjectBox can easily be installed manually. Just download, add the framework to your project, and run our setup script."
  url="https://swift.objectbox.io/manual-installation"
...
![](/img/assets/Screenshot 2019-09-27 at 13.41.15.png)
...
![](/img/assets/Screenshot 2019-09-27 at 13.43.55.png)
...
You can now open your project and [follow the rest of this tutorial](../getting-started).