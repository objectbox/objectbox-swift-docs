---
title: "The setup.rb Script - ObjectBox Swift"
description: "ObjectBox uses a Swift code generator to generate boilerplate code that passes object information to the library. Therefore, you can simply enjoy plain Swift..."
keywords:
  - objectbox
  - swift
  - ios
...
<TechnicalArticleSchema
  headline="The setup.rb Script - ObjectBox Swift"
  description="ObjectBox uses a Swift code generator to generate boilerplate code that passes object information to the library. Therefore, you can simply enjoy plain Swift..."
  url="https://swift.objectbox.io/setup-script"
